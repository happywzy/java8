...
public class WindowJoinDemo {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> textStream9000 = env.socketTextStream("192.168.41.128", 9000, "\n");
        DataStream<String> textStream9001 = env.socketTextStream("192.168.41.128", 9001, "\n");
        //将输入处理一下，变为tuple2
